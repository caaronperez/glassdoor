...
class StatsViewController: UIViewController {
   ...
   var dataEmployer = EmployerStats(id: "String",name: "String",numJobs: "String",squareLogo: "String",rating: "String",numberOfReviews: "String",starImageSrc: "String",reviewsUrl: "String")
//    var dataJob = JobStats(id: "1912083", jobTitle: "MCS", numJobs: "123")
    ...
    func loadEmployeStats(dataRecived: EmployerStats){
        ...
        label1.text = dataRecived.id
        label2.text = dataRecived.name
        label3.text = dataRecived.numJobs
    ...
    func loadCityeStats(dataRecived: CityStats){
        ...
        label1.text = dataRecived.id
        label2.text = dataRecived.latitude
        label3.text = dataRecived.longitude
        label4.text = dataRecived.name
        label5.text = dataRecived.numJobs
